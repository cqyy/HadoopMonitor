...
public class ConfManager {
    private static String conf_dir = "./hadoopmodule/hadoop-utils/FileTransformServer/conf/";             //properties file directory
    private static String conf_name = "transformer.xml";     //properties file name
