...
public final class ConfManager {
    ...
    private static final String conf_dir = "hadoopmodule\\hadoop-utils\\FileTransformClient\\conf\\";             //properties file directory
    private static final String conf_name = "FTConf.xml";     //properties file name
