...
public class MyJobClient {
    ...
    //forbid instance
    private MyJobClient() throws IOException {
        client = SingletonJobClient.getInstance();
    }

    public static MyJobClient getInstance() throws IOException {
        return new MyJobClient();
    }
    ...
    public JobCounter getJobCounter(String jobId){
        ...
        try {
            ...
            for(String groupName : counters.getGroupNames()){
                ...
                for(Counters.Counter counter : group){
                    jobCounter.setValues(counter.getName(),counter.getValue());
                }
            }
            return jobCounter;
        } catch (IOException e) {
